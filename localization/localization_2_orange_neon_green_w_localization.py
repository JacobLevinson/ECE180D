...
# Function to detect orange, green, and red objects
def detect_colors(frame):
    ...
    # Threshold the HSV image to get only orange, green, and red colors
    ...
    # Combine the masks
    combined_mask = cv2.bitwise_or(mask_orange, mask_green, mask_red)
...
def main():
    ...
    while True:
        ...
        # Call function to detect orange, green, and red objects
        result = detect_colors(frame)

        # Display the result
        cv2.imshow('Orange, Green, and Red Detection', result)
